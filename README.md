...
Dear Companion 是一款私密、离线的桌面照片伙伴。你可以把自己准备好的透明人物或宠物图片导入应用，将它们配置为空闲、眨眼、卖萌、摸摸、生气、哭闹和休息等状态，并通过桌面伙伴获得定时休息提醒。
...
- 为多个宠物配置动作素材，缺少特定动作时按确定规则回退。
- 支持单击、双击、悬停、拖动和快速拖动反馈。
...
```text
src/main/       Electron 主进程：生命周期、窗口、托盘、提醒、休息、素材、设置与安全策略
